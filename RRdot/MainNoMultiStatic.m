...
%
figure
subplot(411), plot(time(yST:yET), phaseD1(yST:yET), 'LineWidth', 2); hold on; plot(time(yST:yET), rdot_sim1_(yST:yET), 'LineWidth', 2), title('Radial Velocity $\dot r_1$','interpreter','latex'); xlabel('time[s]'), ylabel('Velocity [m/s]','interpreter','latex'), legend('measurement','ground truth'), xlim([107.99, 111.984]);grid on; grid minor;
subplot(412), plot(time(yST:yET), phaseD2(yST:yET), 'LineWidth', 2); hold on; plot(time(yST:yET), rdot_sim2_(yST:yET), 'LineWidth', 2), title('Radial Velocity $\dot r_2$','interpreter','latex'); xlabel('time[s]'), ylabel('Velocity [m/s]','interpreter','latex'), legend('measurement','ground truth'), xlim([107.99, 111.984]);grid on; grid minor;
subplot(413), plot(time(yST:yET), phaseD3(yST:yET), 'LineWidth', 2); hold on; plot(time(yST:yET), rdot_sim3_(yST:yET), 'LineWidth', 2), title('Radial Velocity $\dot r_3$','interpreter','latex'); xlabel('time[s]'), ylabel('Velocity [m/s]','interpreter','latex'), legend('measurement','ground truth','Location','SouthEast'), xlim([107.99, 111.984]);grid on; grid minor;
subplot(414), plot(time(yST:yET), phaseD4(yST:yET), 'LineWidth', 2); hold on; plot(time(yST:yET), rdot_sim4_(yST:yET), 'LineWidth', 2), title('Radial Velocity $\dot r_4$','interpreter','latex'); xlabel('time[s]'), ylabel('Velocity [m/s]','interpreter','latex'), legend('measurement','ground truth'), xlim([107.99, 111.984]);grid on; grid minor;

rtime = time(yST:yET); 

r1 = r_meas1(yST:yET); r2 = r_meas2(yST:yET); r3 = r_meas2(yST:yET); r4 = r_meas4(yST:yET);
rdot1 = phaseD1(yST:yET); rdot2 = phaseD2(yST:yET); rdot3 = phaseD3(yST:yET); rdot4 = phaseD4(yST:yET);

%save('RF.mat', 'r1', 'r2', 'r3', 'r4', 'rdot1', 'rdot2', 'rdot3', 'rdot4','rtime');
