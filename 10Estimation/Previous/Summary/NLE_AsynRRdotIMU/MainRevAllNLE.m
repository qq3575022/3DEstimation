...
figure
subplot(311), plot(time(1:end-N-1), 0.7*(pos1+1.03)+0.3*x(1,2:end), 'LineWidth', 2); hold on; plot(time, PP1+1.03, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','NorthEast'); title('Position Along x Axis [m]'); xlabel('t [s]'); ylabel('Position [m]'); grid on; grid minor;xlim([107.99, 111.984])
subplot(312), plot(time(1:end-N-1), 0.7*(pos2+1.31)+0.3*x(4,2:end), 'LineWidth', 2); hold on; plot(time, PP2+1.31, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','NorthEast'); title('Position Along y Axis [m]'); xlabel('t [s]'); ylabel('Position [m]'); grid on; grid minor;xlim([107.99, 111.984])
subplot(313), plot(time(1:end-N-1), 0.7*(pos3+1.03)+0.3*x(7,2:end), 'LineWidth', 2); hold on; plot(time, PP2+1.03, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','NorthEast'); title('Position Along z Axis [m]'); xlabel('t [s]'); ylabel('Position [m]'); grid on; grid minor;xlim([107.99, 111.984])
