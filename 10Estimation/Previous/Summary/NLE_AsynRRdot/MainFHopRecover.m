...
%
H1 = NaN(1,length(PP1));     phi1 = zeros(1,length(PP1));       phi21 = NaN(1,length(PP1));  phi31 = zeros(1,length(PP1));       phi41 = NaN(1,length(PP1));
H2 = NaN(1,length(PP1));     phi2 = zeros(1,length(PP1));       phi22 = NaN(1,length(PP1));  phi32 = zeros(1,length(PP1));       phi42 = NaN(1,length(PP1));
H3 = NaN(1,length(PP1));     phi3 = zeros(1,length(PP1));       phi23 = NaN(1,length(PP1));  phi33 = zeros(1,length(PP1));       phi43 = NaN(1,length(PP1));
H4 = NaN(1,length(PP1));     phi4 = zeros(1,length(PP1));       phi24 = NaN(1,length(PP1));  phi34 = zeros(1,length(PP1));       phi44 = NaN(1,length(PP1));
...
offset11 = 0; offset21 = 0; offset31 = 0; offset41 = 0;
offset12 = 0; offset22 = 0; offset32 = 0; offset42 = 0;
offset13 = 0; offset23 = 0; offset33 = 0; offset43 = 0;
offset14 = 0; offset24 = 0; offset34 = 0; offset44 = 0;

for k = 1:1:length(time)-1  
[H1(k+1),phi_mu1(k+1),r_sim1(k+1),r_sim1_(k+1),rdot_sim1(k+1),rdot_sim1_(k+1),phi1(k+1), phi21(k+1), phi31(k+1), phi41(k+1), offset11, offset21, offset31, offset41] = noisysimFHopRecover(x1,f1,Gt,M,X,PT,GT,GR,R,sigma,1,k,z,z_prev,phi1(k),phi31(k),time(k+1)-time(k), offset11, offset21, offset31, offset41);
[H2(k+1),phi_mu2(k+1),r_sim2(k+1),r_sim2_(k+1),rdot_sim2(k+1),rdot_sim2_(k+1),phi2(k+1), phi22(k+1), phi32(k+1), phi42(k+1), offset12, offset22, offset32, offset42] = noisysimFHopRecover(x2,f2,Gt,M,X,PT,GT,GR,R,sigma,2,k,z,z_prev,phi2(k),phi32(k),time(k+1)-time(k), offset12, offset22, offset32, offset42);
[H3(k+1),phi_mu3(k+1),r_sim3(k+1),r_sim3_(k+1),rdot_sim3(k+1),rdot_sim3_(k+1),phi3(k+1), phi23(k+1), phi33(k+1), phi43(k+1), offset13, offset23, offset33, offset43] = noisysimFHopRecover(x3,f3,Gt,M,X,PT,GT,GR,R,sigma,3,k,z,z_prev,phi3(k),phi33(k),time(k+1)-time(k), offset13, offset23, offset33, offset43);   
[H4(k+1),phi_mu4(k+1),r_sim4(k+1),r_sim4_(k+1),rdot_sim4(k+1),rdot_sim4_(k+1),phi4(k+1), phi24(k+1), phi34(k+1), phi44(k+1), offset14, offset24, offset34, offset44] = noisysimFHopRecover(x4,f4,Gt,M,X,PT,GT,GR,R,sigma,4,k,z,z_prev,phi4(k),phi34(k),time(k+1)-time(k), offset14, offset24, offset34, offset44);  
end
...
r_sim1 = r_sim1(yST:yET); r_sim2 = r_sim2(yST:yET); r_sim3 = r_sim3(yST:yET); r_sim4 = r_sim4(yST:yET); 
figure
