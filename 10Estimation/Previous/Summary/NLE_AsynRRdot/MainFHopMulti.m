clc, clear, close all
data=readtable('2.csv','Delimiter', ',');  g=9.7953; load('RFxyz.mat'); load('time.mat')
...
z_prev = NaN(3,length(coord3)-1);z = NaN(3,length(coord3)-1); 
...
r_sim1(1)    = r_sim1(3);     r_sim2(1)   = r_sim2(3);    r_sim3(1)    = r_sim3(3);    r_sim4(1)    = r_sim4(3); 
r_sim1(2)    = r_sim1(3);     r_sim2(2)   = r_sim2(3);    r_sim3(2)    = r_sim3(3);    r_sim4(2)    = r_sim4(3); 

rdot_sim1(1) = rdot_sim1(3); rdot_sim2(1) = rdot_sim2(3); rdot_sim3(1) = rdot_sim3(3); rdot_sim4(1) = rdot_sim4(3); 
rdot_sim1(2) = rdot_sim1(3); rdot_sim2(2) = rdot_sim2(3); rdot_sim3(2) = rdot_sim3(3); rdot_sim4(2) = rdot_sim4(3); 
%
figure
...
%
figure
subplot(411), plot(time,  dmeasr1, 'LineWidth', 1), hold on, plot(time, r_sim1, 'LineWidth', 1), title('Radial Distance $r1$','interpreter','latex'); xlabel('time[s]'), ylabel('Distance [m]','interpreter','latex'), legend('measurement','simulation'), xlim([107.99, 111.984]);
subplot(412), plot(time,  dmeasr2, 'LineWidth', 1), hold on, plot(time, r_sim2, 'LineWidth', 1),title('Radial Distance $r2$','interpreter','latex'); xlabel('time[s]'), ylabel('Distance [m]','interpreter','latex'), legend('measurement','simulation'), xlim([107.99, 111.984]);
subplot(413), plot(time,  dmeasr3, 'LineWidth', 1), hold on, plot(time, r_sim3, 'LineWidth', 1),title('Radial Distance $r3$','interpreter','latex'); xlabel('time[s]'), ylabel('Distance [m]','interpreter','latex'), legend('measurement','simulation'), xlim([107.99, 111.984]);
subplot(414), plot(time,  dmeasr4, 'LineWidth', 1), hold on, plot(time, r_sim4, 'LineWidth', 1),title('Radial Distance $r4$','interpreter','latex'); xlabel('time[s]'), ylabel('Distance [m]','interpreter','latex'), legend('measurement','simulation'), xlim([107.99, 111.984]);
%
% 
% 
figure
