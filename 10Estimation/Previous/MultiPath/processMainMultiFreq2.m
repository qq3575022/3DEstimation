...
%
H1 = NaN(1,length(coord3));   H1_ = NaN(1,length(coord3));  r_sim1 = NaN(1,length(coord3)); r_sim1_ = NaN(1,length(coord3)); rdot_sim1 = NaN(1,length(coord3)); rdot_sim1_ = NaN(1,length(coord3));  phi11 = NaN(1,length(coord3)); phi21 = NaN(1,length(coord3));
H2 = NaN(1,length(coord3));   H2_ = NaN(1,length(coord3));  r_sim2 = NaN(1,length(coord3)); r_sim2_ = NaN(1,length(coord3)); rdot_sim2 = NaN(1,length(coord3)); rdot_sim2_ = NaN(1,length(coord3));  phi12 = NaN(1,length(coord3)); phi22 = NaN(1,length(coord3));
H3 = NaN(1,length(coord3));   H3_ = NaN(1,length(coord3));  r_sim3 = NaN(1,length(coord3)); r_sim3_ = NaN(1,length(coord3)); rdot_sim3 = NaN(1,length(coord3)); rdot_sim3_ = NaN(1,length(coord3));  phi13 = NaN(1,length(coord3)); phi23 = NaN(1,length(coord3));
H4 = NaN(1,length(coord3));   H4_ = NaN(1,length(coord3));  r_sim4 = NaN(1,length(coord3)); r_sim4_ = NaN(1,length(coord3)); rdot_sim4 = NaN(1,length(coord3)); rdot_sim4_ = NaN(1,length(coord3));  phi14 = NaN(1,length(coord3)); phi24 = NaN(1,length(coord3));
