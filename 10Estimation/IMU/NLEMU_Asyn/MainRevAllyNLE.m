...
subplot(313), plot(time(1:end-N), x(9,:), 'LineWidth', 2); hold on; plot(time, -AA1, 'LineWidth', 2); legend('Estimated Acceleration','Ground Truth','Location','SouthEast'); title('Acceleration Along y Axis [m/s^2]'); xlabel('t [s]'); ylabel('Acceleration [m/s^2]'); grid on; grid minor;xlim([57.9176, 61.0160]);
