function [v, v2, r, r2, rdot, rdot2] = noisysimMagMulti(x,f,Gt,M,X,PT,GT,GR,R,sigma,index,k,z,z_prev,T,time1,multi)
...
H      = abs(sqrt((2*R*PT*GT*GR*Gt^2*lambda1^2*X^2*M)/(4*pi)^2*(mul1 + 0.2*mulSum3)^2));%mul + mulSum  % + 0.25* mulSum3 %mul + mulSum2
