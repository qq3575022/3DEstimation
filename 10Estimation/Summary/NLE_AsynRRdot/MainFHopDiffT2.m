...
[H1(k+1),H1_(k+1),r_sim1(k+1),r_sim1_(k+1),rdot_sim1(k+1),rdot_sim1_(k+1),phi1(k+1), phi21(k+1), phi31(k+1), phi41(k+1), offset11, offset21, offset31, offset41] = noisysimFHopDiffT(x1,f1,Gt,M,X,PT,GT,GR,R,sigma,1,k,z,z_prev,phi1(k),phi31(k),time(k+1)-time(k), offset11, offset21, offset31, offset41);
[H2(k+1),H2_(k+1),r_sim2(k+1),r_sim2_(k+1),rdot_sim2(k+1),rdot_sim2_(k+1),phi2(k+1), phi22(k+1), phi32(k+1), phi42(k+1), offset12, offset22, offset32, offset42] = noisysimFHopDiffT(x2,f2,Gt,M,X,PT,GT,GR,R,sigma,2,k,z,z_prev,phi2(k),phi32(k),time(k+1)-time(k), offset12, offset22, offset32, offset42);
[H3(k+1),H3_(k+1),r_sim3(k+1),r_sim3_(k+1),rdot_sim3(k+1),rdot_sim3_(k+1),phi3(k+1), phi23(k+1), phi33(k+1), phi43(k+1), offset13, offset23, offset33, offset43] = noisysimFHopDiffT(x3,f3,Gt,M,X,PT,GT,GR,R,sigma,3,k,z,z_prev,phi3(k),phi33(k),time(k+1)-time(k), offset13, offset23, offset33, offset43);   
[H4(k+1),H4_(k+1),r_sim4(k+1),r_sim4_(k+1),rdot_sim4(k+1),rdot_sim4_(k+1),phi4(k+1), phi24(k+1), phi34(k+1), phi44(k+1), offset14, offset24, offset34, offset44] = noisysimFHopDiffT(x4,f4,Gt,M,X,PT,GT,GR,R,sigma,4,k,z,z_prev,phi4(k),phi34(k),time(k+1)-time(k), offset14, offset24, offset34, offset44);  
end
