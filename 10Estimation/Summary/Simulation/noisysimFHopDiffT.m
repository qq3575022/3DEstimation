function [v, v2, r, r2, rdot, rdot2, phi_mod_gt, phi_mod_gt2, phi_mod, phi_mod2, offset1, offset2, offset3, offset4] = noisysimFHopDiffT(x,f,Gt,M,X,PT,GT,GR,R,sigma,index,k,z,z_prev,phi_prev_mod_gt_load, phi_prev_mod_load, T, offset1, offset2, offset3, offset4)
...
r_  = 3*10^8/(4*pi)*(phi_prev_mod_load -phi_mod2)/(0.1*10^9);%lambda/(4*pi)*phi_mod*1/T;
