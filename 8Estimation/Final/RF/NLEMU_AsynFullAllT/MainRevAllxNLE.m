...
for m = 1:1:length(time)-N
    ...
    [y, i, j, k, index, len] = gety(dmeasr1, dmeasrdot1, dmeasr2, dmeasrdot2, dmeasr3, dmeasrdot3, dmeasr4, dmeasrdot4, magx, gyrox, magy, gyroy, magz, gyroz, accx, accy, accz, accT, gyroT, magT, time, i, j, k, m);
...
subplot(312), plot(time(1:end-N), x(2,:), 'LineWidth', 2); hold on; plot(time, VV1, 'LineWidth', 2); legend('Estimated Velocity','Ground Truth'); title('Velocity Along x Axis [m/s]'); xlabel('t [s]'); ylabel('Velocity [m/s]'); grid on; grid minor;xlim([107.99, 111.984])%xlim([3.5, 7.5])
...
subplot(312), plot(time(1:end-N), x(5,:), 'LineWidth', 2); hold on; plot(time, VV2, 'LineWidth', 2); legend('Estimated Velocity','Ground Truth'); title('Velocity Along y Axis [m/s]'); xlabel('t [s]'); ylabel('Velocity [m/s]'); grid on; grid minor;xlim([107.99, 111.984])%xlim([3.5, 7.5])
