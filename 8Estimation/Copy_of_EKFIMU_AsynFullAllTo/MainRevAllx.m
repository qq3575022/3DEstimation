...
figure
subplot(311), plot(time, -x(7,:), 'LineWidth', 2); hold on; plot(time, PP2, 'LineWidth', 2); legend('Estimated Velocity','Ground Truth'); title('Position Along y Axis [m/s]'); xlabel('t [s]'); ylabel('Velocity [m/s]'); grid on; grid minor;xlim([108.017, 111.984])
subplot(312), plot(time, -x(8,:), 'LineWidth', 3); hold on; plot(time, VV2, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','NorthEast'); title('Velocity Along y Axis [m]'); xlabel('t [s]'); ylabel('Velocity [m/s]'); grid on; grid minor;xlim([108.017, 111.984])
subplot(313), plot(time, -x(9,:), 'LineWidth', 3); hold on; plot(time, AA2, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','SouthEast'); title('Acceleration Along y Axis [m]'); xlabel('t [s]'); ylabel('Acceleration [m/s^2]'); grid on; grid minor;xlim([108.017, 111.984])

figure
subplot(311), plot(time, x(4,:), 'LineWidth', 2); hold on; plot(time, PP3, 'LineWidth', 2); legend('Estimated Acceleration','Ground Truth'); title('Position Along z Axis [m/s^2]'); xlabel('t [s]'); ylabel('Acceleration [m/s^2]'); grid on; grid minor;xlim([108.017, 111.984])
subplot(312), plot(time, x(5,:), 'LineWidth', 3); hold on; plot(time, VV3, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','NorthEast'); title('Velocity Along z Axis [m]'); xlabel('t [s]'); ylabel('Velocity [m/s]'); grid on; grid minor;xlim([108.017, 111.984])
subplot(313), plot(time, x(6,:), 'LineWidth', 3); hold on; plot(time, AA3, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','SouthEast'); title('Acceleration Along z Axis [m]'); xlabel('t [s]'); ylabel('Acceleration [m/s^2]'); grid on; grid minor;xlim([108.017, 111.984])



rmsErrorX = rms(x(1,:)-PP1)
rmsErrorY = rms(x(7,:)+PP2)
rmsErrorZ = rms(x(4,:)-PP3)
%%
figure
