...
% start time
xS = find(abs(acc_time-31.7268)<0.002); xS = xS(1);
xE = find(abs(acc_time-35.5068)<0.001); xE = xE(1);

xxS = find(abs(gyro_time-31.7268)<0.002); xxS = xxS(1);
xxE = find(abs(gyro_time-35.5068)<0.001); xxE = xxE(1);

xSS = find(abs(mag_time-31.7268)<0.005); xSS = xSS(1);
xEE = find(abs(mag_time-35.5068)<0.008); xEE = xEE(1);
...
figure
subplot(311), plot(time, x(1,:), 'LineWidth', 3); hold on; plot(time, PP1, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','SouthEast'); title('Position Along x Axis [m]'); xlabel('t [s]'); ylabel('Position [m]'); grid on; grid minor;xlim([31.7268, 35.5068])
subplot(312), plot(time, x(2,:), 'LineWidth', 2); hold on; plot(time, VV1, 'LineWidth', 2); legend('Estimated Velocity','Ground Truth'); title('Velocity Along x Axis [m/s]'); xlabel('t [s]'); ylabel('Velocity [m/s]'); grid on; grid minor;xlim([31.7268, 35.5068])
subplot(313), plot(time, x(3,:), 'LineWidth', 2); hold on; plot(time, AA1, 'LineWidth', 2); legend('Estimated Acceleration','Ground Truth'); title('Acceleration Along x Axis [m/s^2]'); xlabel('t [s]'); ylabel('Acceleration [m/s^2]'); grid on; grid minor;xlim([31.7268, 35.5068])
