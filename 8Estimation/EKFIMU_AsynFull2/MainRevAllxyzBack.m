clc, clear, close all
data=readtable('6.csv','Delimiter', ',');  g=9.7953;
...
zS = find(abs(acc_time-92.4449)<0.002); zS = zS(1);
zE = find(abs(acc_time-96.6701)<0.002); zE = zE(1);

zzS = find(abs(gyro_time-92.4449)<0.002); zzS = zzS(1);
zzE = find(abs(gyro_time-96.6701)<0.002); zzE = zzE(1);

zSS = find(abs(mag_time-92.4449)<0.015); zSS = zSS(1);
zEE = find(abs(mag_time-96.6701)<0.015); zEE = zEE(1);
...
figure
subplot(311),plot(acc_time, acc_data_x,'LineWidth',3), xlim([80,120]);,%hold on, plot(acc_time, A3_sim(1,:),'LineWidth',2),  hold on, plot(acc_time, A3(1,:),'LineWidth',2),  xlim([0,10]); xlabel('time [s]'), ylabel('x axis ($m/s^2$)','interpreter','latex'),legend('Measurement', 'Simulated', 'Ground Truth with Bias');title('Simulated Accelerations Along x Axe Based on Error Model')
subplot(312),plot(acc_time, acc_data_z,'LineWidth',3), xlim([80,120]);,%hold on, plot(acc_time, -A3_sim(2,:),'LineWidth',2), hold on, plot(acc_time, -A3(2,:),'LineWidth',2), xlim([45,55]); xlabel('time [s]'), ylabel('y axis ($m/s^2$)','interpreter','latex'),legend('Measurement', 'Simulated', 'Ground Truth with Bias');title('Simulated Accelerations Along y Axe Based on Error Model')
subplot(313),plot(acc_time, acc_data_y,'LineWidth',3), xlim([80,120]);,%hold on,plot(acc_time, A3_sim(3,:),'LineWidth',2),hold on,plot(acc_time, A3(3,:),'LineWidth',2),xlim([90,100]); xlabel('time [s]'), ylabel('z axis ($m/s^2$)','interpreter','latex'),legend('Measurement', 'Simulated', 'Ground Truth with Bias');title('Simulated Accelerations Along z Axe Based on Error Model')
...
% covariance for v
RR = [0.8*var(magx), 0.8*var(gyrox), 0.8*var(magy), 0.8*var(gyroy), 0.8*var(magz), 0.8*var(gyroz),0.8*var(accx), 0.8*var(accy), 0.8*var(accz)]; 
...
% figure
% subplot(311), plot(time, x(1,:), 'LineWidth', 3); hold on; plot(time, -PP1, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','SouthEast'); title('Position Along z Axis [m]'); xlabel('t [s]'); ylabel('Position [m]'); grid on; grid minor;xlim([71.4517, 75.4013]);
% subplot(312), plot(time, x(7,:), 'LineWidth', 2); hold on; plot(time, PP2, 'LineWidth', 2); legend('Estimated Velocity','Ground Truth','Location','NorthEast'); title('Velocity Along z Axis [m/s]'); xlabel('t [s]'); ylabel('Velocity [m/s]'); grid on; grid minor;xlim([71.4517, 75.4013]);
% subplot(313), plot(time, x(4,:), 'LineWidth', 2); hold on; plot(time, -PP3, 'LineWidth', 2); legend('Estimated Acceleration','Ground Truth','Location','SouthEast'); title('Acceleration Along z Axis [m/s^2]'); xlabel('t [s]'); ylabel('Acceleration [m/s^2]'); grid on; grid minor;xlim([71.4517, 75.4013]);

figure
subplot(9,1,1), plot(time, x(1,:), 'b', 'LineWidth', 2); hold on; plot(time, PP1, 'LineWidth', 2);%hold on; plot(time, XX(3,:), 'r', 'LineWidth', 2); legend('estimated', 'gt'); title('Estimated acceleration along x axis'); grid on;
subplot(9,1,2), plot(time, x(2,:), 'b', 'LineWidth', 2); hold on; plot(time, VV1, 'LineWidth', 2);%hold on; plot(time, XX(6,:), 'r', 'LineWidth', 2); legend('estimated', 'gt'); title('Estimated acceleration along y axis'); grid on;
subplot(9,1,3), plot(time, x(3,:), 'b', 'LineWidth', 2); hold on; plot(time, AA1, 'LineWidth', 2);%hold on; plot(time, XX(9,:), 'r', 'LineWidth', 2); legend('estimated', 'gt'); title('Estimated acceleration along z axis'); grid on;
subplot(9,1,4), plot(time, x(4,:), 'b', 'LineWidth', 2); hold on; plot(time, PP3, 'LineWidth', 2);%hold on; plot(time,, phi_gt(1,:), 'r', 'LineWidth', 2); legend('estimated', 'gt'); title('Estimated orientation along x axis'); grid on;
subplot(9,1,5), plot(time, x(5,:), 'b', 'LineWidth', 2); hold on; plot(time, VV3, 'LineWidth', 2);%hold on; plot(time, phi_gt(2,:), 'r', 'LineWidth', 2); legend('estimated', 'gt'); title('Estimated angular velocity along x axis'); grid on;
subplot(9,1,6), plot(time, x(6,:), 'b', 'LineWidth', 2); hold on; plot(time, AA3, 'LineWidth', 2);%hold on; plot(td3, phi_gt(3,:), 'r', 'LineWidth', 2); legend('estimated', 'gt'); title('Estimated orientation along y axis'); grid on;
subplot(9,1,7), plot(time, x(7,:), 'b', 'LineWidth', 2); hold on; plot(time, -PP2, 'LineWidth', 2);%hold on; plot(td3, phi_gt(4,:), 'r', 'LineWidth', 2); legend('estimated', 'gt'); title('Estimated angular velocity along y axis'); grid on;
subplot(9,1,8), plot(time, x(8,:), 'b', 'LineWidth', 2); hold on; plot(time, -VV2, 'LineWidth', 2);%hold on; plot(td3, phi_gt(5,:), 'r', 'LineWidth', 2); legend('estimated', 'gt'); title('Estimated orientation along z axis'); grid on;
subplot(9,1,9), plot(time, x(9,:), 'b', 'LineWidth', 2); hold on; plot(time, -AA2, 'LineWidth', 2);%hold on; plot(td3, phi_gt(6,:), 'r', 'LineWidth', 2); legend('estimated', 'gt'); title('Estimated angular velocity along z axis'); grid on;
