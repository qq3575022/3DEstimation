...
yyS = find(abs(gyro_time-41.7827)<0.002);  yyS = yyS(1);
yyE = find(abs(gyro_time-44.6388)<0.002); yyE = yyE(1);

ySS = find(abs(mag_time-41.7827)<0.009);   ySS = ySS(1);
yEE = find(abs(mag_time-44.6388)<0.009); yEE = yEE(1);
...
figure
subplot(311), plot(time, x(7,:), 'LineWidth', 3); hold on; plot(time, -PP1, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','NorthEast'); title('Position Along y Axis [m]'); xlabel('t [s]'); ylabel('Position [m]'); grid on; grid minor;xlim([41.7827, 44.6388]);
subplot(312), plot(time, x(8,:), 'LineWidth', 2); hold on; plot(time, -VV1, 'LineWidth', 2); legend('Estimated Velocity','Ground Truth','Location','SouthEast'); title('Velocity Along y Axis [m/s]'); xlabel('t [s]'); ylabel('Velocity [m/s]'); grid on; grid minor;xlim([41.7827, 44.6388]);
subplot(313), plot(time, x(9,:), 'LineWidth', 2); hold on; plot(time, -AA1, 'LineWidth', 2); legend('Estimated Acceleration','Ground Truth','Location','SouthEast'); title('Acceleration Along y Axis [m/s^2]'); xlabel('t [s]'); ylabel('Acceleration [m/s^2]'); grid on; grid minor;xlim([41.7827, 44.6388]);
