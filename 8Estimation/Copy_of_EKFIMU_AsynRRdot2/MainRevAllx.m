...
time1 = t1(21511:38779) +13.5167;
mag11 = mag1(21511:38779); mag22 = mag2(21511:38779); mag33 = mag3(21511:38779); mag44 = mag4(21511:38779); 
%

figure
subplot(411), plot(time1,  0.016*mag11.^(-0.5)-0.1), hold on, plot(time, r_sim1, 'LineWidth', 2), title('radial distance r1'); xlabel('time[s]'), ylabel('distance [m]'), legend('measurement','ground truth')
subplot(412), plot(time1,  0.006*mag22.^(-0.5)+1.19), hold on, plot(time, r_sim2, 'LineWidth', 2),title('radial distance r2'); xlabel('time[s]'), ylabel('distance [m]'), legend('measurement','ground truth')
subplot(413), plot(time1,  0.016*mag33.^(-0.5)+0.5), hold on, plot(time, r_sim3, 'LineWidth', 2),title('radial distance r3'); xlabel('time[s]'), ylabel('distance [m]'), legend('measurement','ground truth')
subplot(414), plot(time1,  0.01*mag44.^(-0.5)+0.5), hold on, plot(time, r_sim4, 'LineWidth', 2),title('radial distance r4'); xlabel('time[s]'), ylabel('distance [m]'), legend('measurement','ground truth')

%%
phase11 = phase1(21511:38779); phase22 = phase2(21511:38779); phase33 = phase3(21511:38779); phase44 = phase4(21511:38779); 


phaseDiff1 = diff(phase11); phaseDiff2 = diff(phase22);  phaseDiff3 = diff(phase33);  phaseDiff4 = diff(phase44); 

phaseDiff1 = -medfilt1(phaseDiff1,300)*1/(42e-03);
phaseDiff2 = -medfilt1(phaseDiff2,300)*1/(42e-03);
phaseDiff3 = -medfilt1(phaseDiff3,300)*1/(42e-03);
phaseDiff4 = -medfilt1(phaseDiff4,300)*1/(42e-03);

figure
subplot(411), plot(time1(2:end), phaseDiff1); hold on; plot(time, rdot_sim1, 'LineWidth', 2), title('radial velocity r1dot'); xlabel('time[s]'), ylabel('velocity [m/s]'), legend('measurement','ground truth')
subplot(412), plot(time1(2:end), phaseDiff2); hold on; plot(time, rdot_sim2, 'LineWidth', 2), title('radial velocity r2dot'); xlabel('time[s]'), ylabel('velocity [m/s]'), legend('measurement','ground truth')
subplot(413), plot(time1(2:end), phaseDiff3); hold on; plot(time, rdot_sim3, 'LineWidth', 2), title('radial velocity r3dot'); xlabel('time[s]'), ylabel('velocity [m/s]'), legend('measurement','ground truth')
subplot(414), plot(time1(2:end), phaseDiff4); hold on; plot(time, rdot_sim4, 'LineWidth', 2), title('radial velocity r4dot'); xlabel('time[s]'), ylabel('velocity [m/s]'), legend('measurement','ground truth')
%%
measr1 = 0.016*mag11.^(-0.5)-0.1; measr2 = 0.006*mag22.^(-0.5)+1.19; 
measr3 = 0.016*mag33.^(-0.5)+0.5; measr4 = 0.01*mag44.^(-0.5)+0.5;
...
dmeasrdot1(1) = measrdot1(1);
dmeasrdot2(1) = measrdot2(1);
dmeasrdot3(1) = measrdot3(1);
dmeasrdot4(1) = measrdot4(1);
...
dmeasrdot1(2) = measrdot1(2);
dmeasrdot2(2) = measrdot2(2);
dmeasrdot3(2) = measrdot3(2);
dmeasrdot4(2) = measrdot4(2);

figure
subplot(411), plot(time, dmeasr1);
subplot(412), plot(time, dmeasr2);
subplot(413), plot(time, dmeasr3);
subplot(414), plot(time, dmeasr4);

dmeasr1 = medfilt1(dmeasr1,100);
dmeasr2 = medfilt1(dmeasr2,100);
dmeasr3 = medfilt1(dmeasr3,100);
dmeasr4 = medfilt1(dmeasr4,100);



dmeasrdot1 = medfilt1(dmeasrdot1,100);
dmeasrdot2 = medfilt1(dmeasrdot2,100);
dmeasrdot3 = medfilt1(dmeasrdot3,100);
dmeasrdot4 = medfilt1(dmeasrdot4,100);


figure
subplot(411), plot(time, dmeasrdot1);
subplot(412), plot(time, dmeasrdot2);
subplot(413), plot(time, dmeasrdot3);
subplot(414), plot(time, dmeasrdot4);
...
figure
subplot(311), plot(time, x(1,:), 'LineWidth', 3); hold on; plot(time, PP1, 'LineWidth', 2); legend('Estimated Position','Ground Truth','Location','SouthEast'); title('Position Along x Axis [m]'); xlabel('t [s]'); ylabel('Position [m]'); grid on; grid minor;xlim([47.9408, 51.456])
