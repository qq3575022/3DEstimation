function [time, coord3, z, z_prev, H1, H2, H3, H4, H1_, H2_, H3_, H4_, r_sim1, r_sim2, r_sim3, r_sim4, r_sim1_, r_sim2_, r_sim3_, r_sim4_, rdot_sim1, rdot_sim2, rdot_sim3, rdot_sim4, rdot_sim1_, rdot_sim2_, rdot_sim3_, rdot_sim4_, phase1, phase2, phase3, phase4, phi1, phi2, phi3, phi4 , phi21, phi22, phi23, phi24, phi31, phi32, phi33, phi34 , phi41, phi42, phi43, phi44] = get3Dcoord()
...
%
phi1 = NaN(1,length(coord3));   phi21 = NaN(1,length(coord3));  phase1 = NaN(1,length(coord3));   %    phi_mu1 = NaN(1,length(coord3));
phi2 = NaN(1,length(coord3));   phi22 = NaN(1,length(coord3));  phase2 = NaN(1,length(coord3));   %    phi_mu2 = NaN(1,length(coord3));
phi3 = NaN(1,length(coord3));   phi23 = NaN(1,length(coord3));  phase3 = NaN(1,length(coord3));   %    phi_mu3 = NaN(1,length(coord3));
phi4 = NaN(1,length(coord3));   phi24 = NaN(1,length(coord3));  phase4 = NaN(1,length(coord3));   %    phi_mu4 = NaN(1,length(coord3));

%
phi31 = NaN(1,length(coord3));  phi41 = NaN(1,length(coord3));  %phi1 = NaN(1,length(coord3));       phi_mu1 = NaN(1,length(coord3));
phi32 = NaN(1,length(coord3));  phi42 = NaN(1,length(coord3));   %phi2 = NaN(1,length(coord3));       phi_mu2 = NaN(1,length(coord3));
phi33 = NaN(1,length(coord3));  phi43 = NaN(1,length(coord3)); %phi3 = NaN(1,length(coord3));       phi_mu3 = NaN(1,length(coord3));
phi34 = NaN(1,length(coord3));  phi44 = NaN(1,length(coord3));  %phi4 = NaN(1,length(coord3));       phi_mu4 = NaN(1,length(coord3));
