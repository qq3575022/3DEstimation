...
phi_prev_mod  = angle(sqrt(2*R*PT*GT*GR*Gt^2*lambda^2*X^2*M)/(4*pi)*(mul_prev   + 0.1*mulRef1_prev + 0.1*mulRef2_prev + 0.1*mulRef3_prev + 0.1*mulRef4_prev + 0.1*mulRef5_prev + 0.1*mulRef6_prev));%mod(4*pi*sqrt((z_prev(1,k)-x(1))^2+(z_prev(2,k)-x(2))^2)/lambda,2*pi);
phi_prev_mod2 = angle(sqrt(2*R*PT*GT*GR*Gt^2*lambda2^2*X^2*M)/(4*pi)*(mul_prev2 + 0.1*mulRef12_prev+0.1*mulRef22_prev +0.1*mulRef32_prev+0.1*mulRef42_prev+0.1*mulRef52_prev+0.1*mulRef62_prev));%mod(4*pi*sqrt((z_prev(1,k)-x(1))^2+(z_prev(2,k)-x(2))^2)/lambda,2*pi);
...
phi_mod      = angle(sqrt(2*R*PT*GT*GR*Gt^2*lambda^2*X^2*M)/(4*pi)*(mul + 0.1*mulRef1 + 0.1*mulRef2 + 0.1*mulRef3+0.1*mulRef4+0.1*mulRef5+0.1*mulRef6));%4*pi*sqrt((z(1,k)-x(1))^2+(z(2,k)-x(2))^2+(z(3,k)-x(3))^2)/lambda; %4*pi*sqrt((z(1,k)-x(1))^2+(z(2,k)-x(2))^2+(z(3,k)-x(3))^2)/lambda;%mod(4*pi*sqrt((z(1,k)     -x(1))^2+(z(2,k)     -x(2))^2)/lambda,2*pi);
phi_mod2     = angle(sqrt(2*R*PT*GT*GR*Gt^2*lambda2^2*X^2*M)/(4*pi)*(mul2 + 0.1*mulRef12+0.1*mulRef22+0.1*mulRef32+0.1*mulRef42+0.1*mulRef52+0.1*mulRef62));%4*pi*sqrt((z(1,k)-x(1))^2+(z(2,k)-x(2))^2+(z(3,k)-x(3))^2)/lambda2;%mod(4*pi*sqrt((z(1,k)     -x(1))^2+(z(2,k)     -x(2))^2)/lambda,2*pi);
phase = phi_mod2;
% Angle
