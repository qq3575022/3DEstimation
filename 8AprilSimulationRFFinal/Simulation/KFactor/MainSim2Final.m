...
figure
subplot(411), plot(time(1:end-10000), medfilt1(m41, 10000),'LineWidth', 2);title('K Value for Reader 1 in Simulation');ylabel('K Value'); grid on; grid minor;ylim([0,10000]);%xlim([40,60])
subplot(412), plot(time(1:end-10000), medfilt1(m42, 10000),'LineWidth', 2);title('K Value for Reader 2 in Simulation');ylabel('K Value'); grid on; grid minor;ylim([0,10000]);%xlim([40,60])
subplot(413), plot(time(1:end-10000), medfilt1(m43, 10000),'LineWidth', 2);title('K Value for Reader 3 in Simulation');ylabel('K Value'); grid on; grid minor;ylim([0,10000]);%xlim([40,60])
subplot(414), plot(time(1:end-10000), medfilt1(m44, 10000),'LineWidth', 2);title('K Value for Reader 4 in Simulation');ylabel('K Value'); grid on; grid minor;ylim([0,10000]);%xlim([40,60]);xlabel('time [s]');
