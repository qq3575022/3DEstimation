...
[H1(k+1),H1_(k+1),r_sim1(k+1),r_sim1_(k+1),r_meas1(k+1),rphase1(k+1),rdot_sim1(k+1),rdot_sim1_(k+1),phigt1_1(k+1),phigt2_1(k+1),phi1_1(k+1),phi2_1(k+1),phi3_1(k+1),phi4_1(k+1),offset11,offset21,offset31,offset41,offset51,offset61] = noisysimMultiStatic(x1,f1,Gt,M,X,PT,0.7*GT,GR,R,sigma,k,z,z_prev,phigt1_1(k),phi1_1(k),phi4_1(k),time(k+1)-time(k),magD12(k),offset11,offset21,offset31,offset41,offset51,offset61);
[H2(k+1),H2_(k+1),r_sim2(k+1),r_sim2_(k+1),r_meas2(k+1),rphase2(k+1),rdot_sim2(k+1),rdot_sim2_(k+1),phigt1_2(k+1),phigt2_2(k+1),phi1_2(k+1),phi2_2(k+1),phi3_2(k+1),phi4_2(k+1),offset12,offset22,offset32,offset42,offset52,offset62] = noisysimMultiStatic(x2,f2,Gt,M,X,PT,  7*GT,GR,R,sigma,k,z,z_prev,phigt1_2(k),phi1_2(k),phi4_2(k),time(k+1)-time(k),magD22(k),offset12,offset22,offset32,offset42,offset52,offset62);
[H3(k+1),H3_(k+1),r_sim3(k+1),r_sim3_(k+1),r_meas3(k+1),rphase3(k+1),rdot_sim3(k+1),rdot_sim3_(k+1),phigt1_3(k+1),phigt2_3(k+1),phi1_3(k+1),phi2_3(k+1),phi3_3(k+1),phi4_3(k+1),offset13,offset23,offset33,offset43,offset53,offset63] = noisysimMultiStatic(x3,f3,Gt,M,X,PT,    GT,GR,R,sigma,k,z,z_prev,phigt1_3(k),phi1_3(k),phi4_3(k),time(k+1)-time(k),magD32(k),offset13,offset23,offset33,offset43,offset53,offset63);   
[H4(k+1),H4_(k+1),r_sim4(k+1),r_sim4_(k+1),r_meas4(k+1),rphase4(k+1),rdot_sim4(k+1),rdot_sim4_(k+1),phigt1_4(k+1),phigt2_4(k+1),phi1_4(k+1),phi2_4(k+1),phi3_4(k+1),phi4_4(k+1),offset14,offset24,offset34,offset44,offset54,offset64] = noisysimMultiStatic(x4,f4,Gt,M,X,PT,0.5*GT,GR,R,sigma,k,z,z_prev,phigt1_4(k),phi1_4(k),phi4_4(k),time(k+1)-time(k),magD42(k),offset14,offset24,offset34,offset44,offset54,offset64);  

rphase1(k+1) = rphase1(k+1) + 26.8+3.6-32+1.7*2+0.06;
rphase2(k+1) = rphase2(k+1) + 3.13+27-32+1.8*2+0.13;
rphase3(k+1) = rphase3(k+1) + 0.1+1.5;
rphase4(k+1) = rphase4(k+1) + 1.52;

% rphase1(k+1) = rphase1(k+1) + 26.8+2.7 - 31.7 + 1.68+0.4;
% rphase2(k+1) = rphase2(k+1) + 0.3- 1.2 + 1.0;
...
% r_phase(:,k+1) = lsqnonlin(@(xx)getMulPath(rphase1(k+1),rphase2(k+1),rphase3(k+1),rphase4(k+1), x1, x2, x3, x4, xx), [0,0,0]);
...
%%
figure
subplot(411), plot(time(yST:yET), 3*10/(4*pi)*(phi4_1(yST:yET) - phi3_1(yST:yET)));hold on; plot(time(yST:yET), radial(1,yST:yET),'LineWidth',2);
subplot(412), plot(time(yST:yET), 3*10/(4*pi)*(phi4_2(yST:yET) - phi3_2(yST:yET))+7.5);hold on; plot(time(yST:yET), radial(2,yST:yET),'LineWidth',2)
subplot(413), plot(time(yST:yET), 3*10/(4*pi)*(phi4_3(yST:yET) - phi3_3(yST:yET)));hold on; plot(time(yST:yET), radial(3,yST:yET),'LineWidth',2)
subplot(414), plot(time(yST:yET), 3*10/(4*pi)*(phi4_4(yST:yET) - phi3_4(yST:yET)));hold on; plot(time(yST:yET), radial(4,yST:yET),'LineWidth',2)
%%
figure
subplot(411), plot(time(yST:yET), 3*10/(4*pi)*(phi1_1(yST:yET) - phi2_1(yST:yET)));hold on; plot(time(yST:yET), radial(1,yST:yET),'LineWidth',2);
subplot(412), plot(time(yST:yET), 3*10/(4*pi)*(phi1_2(yST:yET) - phi2_2(yST:yET)));hold on; plot(time(yST:yET), radial(2,yST:yET),'LineWidth',2)
subplot(413), plot(time(yST:yET), 3*10/(4*pi)*(phi1_3(yST:yET) - phi2_3(yST:yET)));hold on; plot(time(yST:yET), radial(3,yST:yET),'LineWidth',2)
subplot(414), plot(time(yST:yET), 3*10/(4*pi)*(phi1_4(yST:yET) - phi2_4(yST:yET))+7.5);hold on; plot(time(yST:yET), radial(4,yST:yET),'LineWidth',2)
...
meas  = sqrt(rms(coord3(1,yST:yET) - r_meas(1,yST:yET)).^2  + rms(coord3(2,yST:yET) - r_meas(2,yST:yET)).^2  + rms(coord3(3,yST:yET) - r_meas(3,yST:yET)).^2)
mag   = sqrt(rms(coord3(1,yST:yET) - r_sim(1,yST:yET)).^2   + rms(coord3(2,yST:yET) - r_sim(2,yST:yET)).^2   + rms(coord3(3,yST:yET) - r_sim(3,yST:yET)).^2)
phase = sqrt(rms(coord3(1,yST:yET) - r_phase(1,yST:yET)).^2 + rms(coord3(2,yST:yET) - r_phase(2,yST:yET)).^2 + rms(coord3(3,yST:yET) - r_phase(3,yST:yET)).^2)
