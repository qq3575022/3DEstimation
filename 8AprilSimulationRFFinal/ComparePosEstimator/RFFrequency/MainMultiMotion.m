...
[H1(k+1),H1_(k+1),r_sim1(k+1),r_sim1_(k+1),r_meas1(k+1),rphase1(k+1),rdot_sim1(k+1),rdot_sim1_(k+1),phigt1_1(k+1),phigt2_1(k+1),phi1_1(k+1),phi2_1(k+1),phi3_1(k+1),phi4_1(k+1),offset11,offset21,offset31,offset41,offset51,offset61] = noisysimMultiMotion(x1,f1,Gt,M,X,PT,0.7*GT,GR,R,sigma,k,z,z_prev,phigt1_1(k),phi1_1(k),phi4_1(k),time(k+1)-time(k),magD12(k),offset11,offset21,offset31,offset41,offset51,offset61);
[H2(k+1),H2_(k+1),r_sim2(k+1),r_sim2_(k+1),r_meas2(k+1),rphase2(k+1),rdot_sim2(k+1),rdot_sim2_(k+1),phigt1_2(k+1),phigt2_2(k+1),phi1_2(k+1),phi2_2(k+1),phi3_1(k+1),phi4_2(k+1),offset12,offset22,offset32,offset42,offset52,offset62] = noisysimMultiMotion(x2,f2,Gt,M,X,PT,  7*GT,GR,R,sigma,k,z,z_prev,phigt1_2(k),phi1_2(k),phi4_2(k),time(k+1)-time(k),magD22(k),offset12,offset22,offset32,offset42,offset52,offset62);
[H3(k+1),H3_(k+1),r_sim3(k+1),r_sim3_(k+1),r_meas3(k+1),rphase3(k+1),rdot_sim3(k+1),rdot_sim3_(k+1),phigt1_3(k+1),phigt2_3(k+1),phi1_3(k+1),phi2_3(k+1),phi3_1(k+1),phi4_3(k+1),offset13,offset23,offset33,offset43,offset53,offset63] = noisysimMultiMotion(x3,f3,Gt,M,X,PT,    GT,GR,R,sigma,k,z,z_prev,phigt1_3(k),phi1_3(k),phi4_3(k),time(k+1)-time(k),magD32(k),offset13,offset23,offset33,offset43,offset53,offset63);   
[H4(k+1),H4_(k+1),r_sim4(k+1),r_sim4_(k+1),r_meas4(k+1),rphase4(k+1),rdot_sim4(k+1),rdot_sim4_(k+1),phigt1_4(k+1),phigt2_4(k+1),phi1_4(k+1),phi2_4(k+1),phi3_1(k+1),phi4_4(k+1),offset14,offset24,offset34,offset44,offset54,offset64] = noisysimMultiMotion(x4,f4,Gt,M,X,PT,0.5*GT,GR,R,sigma,k,z,z_prev,phigt1_4(k),phi1_4(k),phi4_4(k),time(k+1)-time(k),magD42(k),offset14,offset24,offset34,offset44,offset54,offset64);  

rphase1(k+1) = rphase1(k+1)+0.9-1.0+30.4;%-0.03;
rphase2(k+1) = rphase2(k+1)+30.4;%+3.8;
