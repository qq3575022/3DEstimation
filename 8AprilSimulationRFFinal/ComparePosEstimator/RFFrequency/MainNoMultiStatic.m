...
rmeas  = 100*[rms(r_meas1(yST:yET) - radial(1,yST:yET)), rms(r_meas2(yST:yET) - radial(2,yST:yET)), rms(r_meas3(yST:yET) - radial(3,yST:yET)), rms(r_meas4(yST:yET) - radial(4,yST:yET))]
rmag   = 100*[rms(r_sim1(yST:yET)  - radial(1,yST:yET)), rms(r_sim2(yST:yET)  - radial(2,yST:yET)), rms(r_sim3(yST:yET) - radial(3,yST:yET)),  rms(r_sim4(yST:yET)  - radial(4,yST:yET))]
rphase = 100*[rms(rphase1(yST:yET) - radial(1,yST:yET)), rms(rphase2(yST:yET) - radial(2,yST:yET)), rms(rphase3(yST:yET) - radial(3,yST:yET)), rms(rphase4(yST:yET) - radial(4,yST:yET))]

meas  = 100*sqrt(rms(coord3(1,yST:yET) - r_meas(1,yST:yET)).^2  + rms(coord3(2,yST:yET) - r_meas(2,yST:yET)).^2  + rms(coord3(3,yST:yET) - r_meas(3,yST:yET)).^2)
mag   = 100*sqrt(rms(coord3(1,yST:yET) - r_sim(1,yST:yET)).^2   + rms(coord3(2,yST:yET) - r_sim(2,yST:yET)).^2   + rms(coord3(3,yST:yET) - r_sim(3,yST:yET)).^2)
phase = 100*sqrt(rms(coord3(1,yST:yET) - r_phase(1,yST:yET)).^2 + rms(coord3(2,yST:yET) - r_phase(2,yST:yET)).^2 + rms(coord3(3,yST:yET) - r_phase(3,yST:yET)).^2)
%%
