function [v, v2, rmag, rgt, rmeas, rphase, rdot, rdotgt, phi_mod_gt, phi_mod_gt2, phi_mod, phi_mod2, offset1, offset2, offset3, offset4] = noisysimNoMultiMotion(x,f,Gt,M,X,PT,GT,GR,R,sigma,k,z,z_prev,phi_prev_mod_gt_load, phi_prev_mod_load, T, Hmeas, offset1, offset2, offset3, offset4)
% ============================================= Magnitude =================================================
Delta_f = 0.1*10^8;    lambda = 3*10^8/f;     lambda2 = 3*10^8/(f+Delta_f);
...
rphase  = 3*10^8/(4*pi)*(phi_prev_mod_gt_load - phi_mod_gt2)/Delta_f;%lambda/(4*pi)*phi_mod*1/T;
