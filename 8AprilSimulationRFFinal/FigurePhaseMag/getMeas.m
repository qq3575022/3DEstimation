...
magD1 = abs(D1)+0.0001246;%+0.0002284;
phaseD1 = angle(D1);
...
magD2 = abs(D2)+0.000242+0.000346;%%+0.0006892;
phaseD2 = angle(D2);
...
magD4 = NaN(length(magD2), 1);   magD4(1:length(D04)) = abs(D4)+0.00015078;   
